...
public class GameState {
    // Use an enum for a game state with intializing, running, paused and game over states
    public enum State {
        INITIALIZING, RUNNING, PAUSED, GAME_OVER
    }
    // enum is a callection of public static final values
    // behind the scences, each of these has an associated integer value, the ordinal
    ...
    public void startGame() {
        ...
        // currentState is a variable of type State and can have only one of the four values in enum
